                    ...
                    <div class="card gradient-1">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white"> {{ \App\Models\TraningCategory::count() }}</h2>
                            </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-2">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{ \App\Models\Traning::count() }}</h2>
                            </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-4">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white">{{ \App\Models\TraningOrder::count() }}</h2>
                            </div>
