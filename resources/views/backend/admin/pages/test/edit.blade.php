                            ...
                            <div class="basic-form">
                                <form action="{{ route('admin.test.update',$test->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="title" value="{{ $test->title ?? old('title') }}" class="form-control @error('title') is-invalid @enderror" placeholder="Category Name">
                                            @error('title')
                                            <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="fit">
                                            <img class="fit-image" src="{{ $test->image ? asset($test->image) : asset('images/default.jpg') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="price" value="{{ $test->price ?? old('price') }}" class="form-control @error('price') is-invalid @enderror" placeholder="Category Name">
                                            @error('price')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
