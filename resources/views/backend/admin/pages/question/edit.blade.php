                            ...
                            <div class="basic-form">
                                <form action="{{ route('admin.question.update',$question->id) }}" method="post">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="categories_id" id="category" class="form-control">
                                                ...
                                                @foreach($categories as $category)
                                                    <option value="{{ optional($category)->id }} {{ $question->categories_id == $category->id ? 'selected' : '' }} ">{{ optional($category)->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <select name="sub_categories_id" id="subCategory" class="form-control">
                                                @foreach($sub_categories as $category)
                                                    <option value="{{ $category->id }} {{ $question->sub_categories_id == $category->id ? 'selected' : '' }}">{{ $category->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="title" class="form-control" value="{{ $question->title ?? '' }}" placeholder="Category Name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
