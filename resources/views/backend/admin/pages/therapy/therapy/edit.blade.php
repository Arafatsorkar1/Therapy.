                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <form action="{{ route('admin.language-therapy.update',$languageTherapy->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Title<span class="text-danger">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="text" name="title" value="{{ $languageTherapy->title ?? old('title') }}" class="form-control @error('title') is-invalid @enderror" placeholder="Category Name">
                                            @error('title')
                                            <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="fit">
                                            <img class="fit-image" src="{{ $languageTherapy->image ? asset($languageTherapy->image) : asset('images/default.jpg') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="price" value="{{ $languageTherapy->price ?? old('price') }}" class="form-control @error('price') is-invalid @enderror" placeholder="Category Name">
                                            @error('price')
                                            <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 input-group">
                                            <input type="number" name="serial" value="{{ $languageTherapy->serial ?? old('serial') }}" class="form-control" placeholder="Serial Number">
