...
@section('title','Create Language Therapy Category')
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <form action="{{ route('admin.language-therapy-category.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="short_description" class="form-control @error('short_description') is-invalid @enderror" id="short_description" rows="7">{!!  old('short_description') !!}</textarea>
