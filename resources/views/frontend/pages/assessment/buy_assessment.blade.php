            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="border shadow p-5">
                        ...
                        <form class="border border-dark p-3" action="{{ route('assessment-buy') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Assessment Title</label>
                                <div class="col-sm-10">
                                    <input type="text" name="title" readonly value="{{ $category->name}}" class="form-control @error('title') is-invalid @enderror">
                                    <input type="hidden" name="categories_id" readonly value="{{ $category->id }}" class="form-control @error('tranings_id') is-invalid @enderror">
{{--                                    <input type="hidden" name="user_assessments_id" readonly value="{{ $user_assessment->id }}" class="form-control @error('user_assessments_id') is-invalid @enderror">--}}
                                    @error('user_assessments_id')
                                    <small>{{ $message }}</small>
                                    @enderror
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="price" value="1000" readonly class="form-control @error('price') is-invalid @enderror">
                                    @error('price')
                                    <small>{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input required type="number" name="pay_balance" value="{{ old('pay_balance') }}" class="form-control @error('pay_balence') is-invalid @enderror" placeholder="Pay Balance">
                                    @error('pay_balance')
                                    <small>{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input required type="number" name="sended_number" value="{{ old('sended_number') }}" class="form-control @error('sended_number') is-invalid @enderror" placeholder="Sended Number">
                                    @error('sended_number')
                                    <small>{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input required type="text" name="transaction_id" value="{{ old('transaction_id') }}" class="form-control @error('transaction_id') is-invalid @enderror" placeholder="Transaction Id">
