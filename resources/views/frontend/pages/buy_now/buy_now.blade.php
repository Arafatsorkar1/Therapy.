            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="border shadow p-5">
                        ...
                        <form class="border border-dark p-3" action="{{ route('traning-buy') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Therapy Title</label>
                                <div class="col-sm-10">
                                    <input type="text" name="" readonly value="{{ $traning->title }}" class="form-control @error('title') is-invalid @enderror">
                                    <input type="hidden" name="traning_id" readonly value="{{ $traning->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" value="{{$traning->price}}" readonly class="form-control @error('price') is-invalid @enderror">
                                    @error('price')
                                    <small>{{ $message }}</small>
                                    @enderror
                                </div>
