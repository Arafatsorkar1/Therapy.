            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="border shadow p-5">
                        ...
                        <form class="border border-dark p-3" action="{{ route('therapy-order') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Therapy Title</label>
                                <div class="col-sm-10">
                                    <input type="text" name="" readonly value="{{ $therapy->title }}" class="form-control @error('title') is-invalid @enderror">
                                    <input type="hidden" name="therapy_id" readonly value="{{ $therapy->id }}">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Therapy Price</label>
                                <div class="col-sm-10">
                                    <input type="number" value="{{$therapy->price}}" readonly class="form-control @error('price') is-invalid @enderror">
                                    @error('price')
                                    <small>{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            {{--                                <div class="col-sm-3">--}}
                            {{--                                    <input type="radio" name="payment_method" required value="bkash" class="form-control @error('title') is-invalid @enderror" placeholder="Traning Title"><label--}}
                            {{--                                        for="">bKash (017********)</label>--}}
                            {{--                                </div>--}}
                            {{--                                <div class="col-sm-3">--}}
                            {{--                                    <input type="radio" name="payment_method" required value="rocket" class="form-control @error('title') is-invalid @enderror" placeholder="Traning Title"><label--}}
                            {{--                                        for="">Rocket (018********)</label>--}}
                            {{--                                </div>--}}
                            {{--                                <div class="col-sm-3">--}}
                            {{--                                    <input type="radio" name="payment_method" required value="nagod" class="form-control @error('title') is-invalid @enderror" placeholder="Traning Title"><label--}}
                            {{--                                        for="">Nagoad (017********)</label>--}}
                            {{--                                </div>--}}
                            {{--                            </div>--}}
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Payment Method <span class="text-danger">*</span></label>
