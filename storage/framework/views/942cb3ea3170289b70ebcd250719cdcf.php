<?php $__env->startSection('title','Add Traning'); ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <form action="<?php echo e(route('admin.traning.store')); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"  id="traning_categories_id">
                                            ...
                                            <?php $__currentLoopData = $t_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e(optional($category)->id); ?>"><?php echo e(optional($category)->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="title_sub" value="<?php echo e(old('title_sub')); ?>" class="form-control <?php $__errorArgs = ['title_sub'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('backend.admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php\Banglasoft\basic\htdocs\Therapylabonline\resources\views/backend/admin/pages/traning/create.blade.php ENDPATH**/ ?>